...
then
    ...
    basedir=/mnt/data0/mmarsha/thinmad/$modelname/
...
dumpnumm1=`printf "%04d" "$decidumpnumm1"` # added by Megan 12/16/15
...
dumpnump1=`printf "%04d" "$decidumpnump1"` #added by Megan 12/16/15
