...
###by user Ali_M from http://pastebin.com/x1NJqWWm#

import numpy as np
import scipy as sp
from scipy.ndimage import convolve #look up how this works
...
def norm_xcorr(t,a,method=None,trim=True,do_ssd=False):
        ...
        t = np.float64(t) #what does this do? why after std, mean?
        a = np.float64(a)
        ...
        if method == 'fourier':
                ...
                xcorr = convolve(a,t,mode='constant',cval=0) #figure out the difference between correlate, convolve
